        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModifiedMoney = table.Column<float>(type: "real", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeactive = table.Column<bool>(type: "bit", nullable: false),
                    BooksImage = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaidedSalaries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PaidedSalaries_Employers_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistoryEmployees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HistoryEmployees_Employers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HistoryEmployees_Histories_HistoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeePositions_Employers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "HasAdmins",
                columns: new[] { "Id", "HasAdmin" },
                values: new object[] { 1, false });

            migrationBuilder.InsertData(
                table: "Kassas",
                columns: new[] { "Id", "Balance", "LastModified", "LastModifiedBy", "LastModifiedMoney", "LastModifiedTime" },
                values: new object[] { 1, 0f, "Hal hazırda yoxdur", "Hal hazırda yoxdur", 0f, new DateTime(2022, 11, 30, 9, 14, 1, 53, DateTimeKind.Utc).AddTicks(968) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistoryEmployees_EmployeeId",
                table: "HistoryEmployees",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_HistoryEmployees_HistoryId",
                table: "HistoryEmployees",
                column: "HistoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PaidedSalaries_EmployeeId",
                table: "PaidedSalaries",
                column: "EmployeeId");
        }
